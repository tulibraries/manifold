...
module Manifold
  class Application < Rails::Application
    ...
    config.hours_worksheet_24_7 = "C2:C"
    config.hours_worksheet_asrs = "D2:D"
    config.hours_worksheet_guest_computers = "E2:E"
    config.hours_worksheet_scholars_studio = "F2:F"
    config.hours_worksheet_service_zone = "G2:G"
    config.hours_worksheet_scrc = "H2:H"
    config.hours_worksheet_cafe = "I2:I"
    config.hours_worksheet_exhibits = "J2:J"
    config.hours_worksheet_ambler = "K2:K"
    config.hours_worksheet_blockson = "L2:L"
    config.hours_worksheet_ginsburg = "M2:M"
    config.hours_worksheet_innovation = "N2:N"
    config.hours_worksheet_podiatry = "O2:O"
    config.hours_worksheet_ask_a_librarian = "P2:P"
    config.hours_worksheet_success_center = "P2:P"
