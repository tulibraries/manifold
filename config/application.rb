...
module Manifold
  class Application < Rails::Application
    ...
    config.hours_spreadsheet_date_cells = "Hours!A2:Q"
    config.hours_worksheet = "Hours"
    config.hours_today = "today!A2:A2"
    config.hours_worksheet_charles = "{Hours!A2:A, Hours!B2:B]}"
    config.hours_worksheet_24_7 = "Hours!C2:C"
    config.hours_worksheet_asrs = "Hours!D2:D"
    config.hours_worksheet_guest_computers = "Hours!E2:E"
    config.hours_worksheet_scholars_studio = "Hours!F2:F"
    config.hours_worksheet_service_zone = "Hours!G2:G"
    config.hours_worksheet_scrc = "Hours!H2:H"
    config.hours_worksheet_cafe = "Hours!I2:I"
    config.hours_worksheet_exhibits = "Hours!J2:J"
    config.hours_worksheet_ambler = "Hours!K2:K"
    config.hours_worksheet_blockson = "Hours!L2:L"
    config.hours_worksheet_ginsburg = "Hours!M2:M"
    config.hours_worksheet_innovation = "Hours!N2:N"
    config.hours_worksheet_podiatry = "Hours!O2:O"
    config.hours_worksheet_ask_a_librarian = "Hours!P2:P"
    config.hours_worksheet_success_center = "Hours!P2:P"
