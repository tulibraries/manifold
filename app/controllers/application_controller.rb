...
class ApplicationController < ActionController::Base
  ...
  def set_footer
    ...
    @jobs_link = Webpage.find_by_slug("jobs")
    @publications_link = Webpage.find_by_slug("system-summary")
    @numbers_link = Webpage.find_by_slug("numbers")
    @social_links = Webpage.find_by_slug("social-media")
    @donate_link = Policy.find_by_slug("donations")
    @diversity_link = Webpage.find_by_slug("diversity")
