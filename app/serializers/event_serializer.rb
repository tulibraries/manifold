...
class EventSerializer
  ...
  attributes :title, :description, :start_time, :end_time, :cancelled, :registration_status, :registration_link, :content_hash, :alt_text, :ensemble_identifier, :tags, :all_day, :image
