...
RSpec.describe "Charles Library Event Space Request", type: :request do
  ...
  let(:form_params) {
    { form: {
      form_type:, title:, recipients: "[\"recipient@example.com\"]", name: "1234567890", email: "test_id@temple.edu", phone: "215-204-3836", department: "LTD", organizing_name: "Organizing Name", organizing_phone: "Organizing phone",
