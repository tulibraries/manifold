...
class AddRichTextFieldToModels < ActiveRecord::Migration[6.0]
  ...
  change_table :alerts, bulk: true do |a|
    def up
  ...
  change_table :buildings, bulk: true do |b|
    def up
      ...
      remove_column :buildings, :covid_alert
  ...
  change_table :categories, bulk: true do |ca|
    def up
  ...
  change_table :collections, bulk: true do |co|
    def up
  ...
  change_table :exhibitions, bulk: true do |ex|
    def up
  ...
  change_table :finding_aids, bulk: true do |fa|
    def up
  ...
  change_table :groups, bulk: true do |g|
    def up
  ...
  change_table :policies, bulk: true do |p|
    def up
  ...
  change_table :services, bulk: true do |se|
    def up
  ...
  change_table :spaces, bulk: true do |sp|
    def up
  ...
  change_table :webpages, bulk: true do |w|
    def up
