...
RSpec.shared_examples "routes_for_imageable" do
  ...
  let(:thumnbnail_path) { send("#{model_name_from_controller}_image_thumbnail_path", factory_model.to_param) }
  let(:medium_path) { send("#{model_name_from_controller}_image_medium_path", factory_model.to_param) }
  let(:large_path) { send("#{model_name_from_controller}_image_large_path", factory_model.to_param) }
